...
console.assert(cityArr.length === 153); // 合共153市 = 香港1市 + 澳门1市 + 广东21市 + 广西14市 + 湖南14市 + 江西11市 + 福建9市 + 海南18市 + 贵州9市 + 云南16市 + 重庆1市 + 四川21市 + 湖北17市
...
for (let i = 0; i < cityArr.length; ++i) {
	...
	for (var parentIndex = 0; !(i < [1, 2, 23, 37, 51, 62, 71, 89, 98, 114, 115, 136, 153][parentIndex]); ++parentIndex);
	const parentCode = ['XG', 'AM', 'GD', 'GX', 'HN', 'JX', 'FJ', 'HI', 'GZ', 'YN', 'CQ', 'SC', 'HB'][parentIndex]; // Note the exception of 海南, whose code is HI instead of HN.
