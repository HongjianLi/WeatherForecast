...
console.assert(cityArr.length === 213); // 合共153市 = 香港1市 + 澳门1市 + 广东21市 + 广西14市 + 湖南14市 + 江西11市 + 福建9市 + 海南18市 + 贵州9市 + 云南16市 + 重庆1市 + 四川21市 + 湖北17市 + 安徽16市 + 浙江11市 + 上海1市 + 江苏13市 + 河南12市(部分) + 陕西5市(部分) + 甘肃2市(部分)
...
for (let i = 0; i < cityArr.length; ++i) {
	...
	for (var parentIndex = 0; !(i < [1, 2, 23, 37, 51, 62, 71, 89, 98, 114, 115, 136, 153, 169, 180, 181, 194, 206, 211, 213][parentIndex]); ++parentIndex);
	const parentCode = ['XG', 'AM', 'GD', 'GX', 'HN', 'JX', 'FJ', 'HI', 'GZ', 'YN', 'CQ', 'SC', 'HB', 'AH', 'ZJ', 'SH', 'JS', 'HA', 'SN', 'GS'][parentIndex]; // The pinyin initials of 湖南, 海南, 河南 are HN. To distinguish, their codes are HN, HI, HA. The pinyin initials of 山西, 陕西 are SX. To distinguish, their codes are SX, SN.
