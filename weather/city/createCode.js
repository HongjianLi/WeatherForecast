...
const code0Arr = ['10132', '10133', '10128', '10130', '10125', '10124', '10123', '10131', '10126', '10129', '10104', '10127', '10120', '10122', '10121', '10102', '10119' ]; // They are the codes of provinces [ '香港', '澳门', '广东', '广西', '湖南', '江西', '福建', '海南', '贵州', '云南', '重庆', '四川', '湖北', '安徽', '浙江', '上海', '江苏' ]
...
for (let k = 0; k < code0Arr.length; ++k) {
	...
	for (let j = 1; j <= maxNumCities; ++j) {
		...
		for (let i = 0; i < 3; ++i) {
			const code2 = ['01', '00', '09', '07'][i]; // All city codes end with either 01, 00, 09, 07. Most codes end with 01. Three codes end with 00 (佛山,益阳,上海). One code ends with 09 (湘西). One code ends with 07 (绍兴).
