...
const features = [].concat(...await Promise.all((await fs.readdir('.')).reduce((cityArr, city) => { // The geojson files were downloaded from https://www.poi86.com/
	const provinceIndex = ['香港', '澳门', '广东', '广西', '湖南', '江西', '福建', '海南', '贵州', '云南', '重庆', '四川', '湖北', '安徽', '浙江', '上海', '江苏', '河南', '陕西', '甘肃', '山东', '河北', '山西', '宁夏', '青海', '天津', '北京', '内蒙古', '辽宁', '吉林', '黑龙江', '西藏', '新疆'].findIndex(province => city.startsWith(province));
