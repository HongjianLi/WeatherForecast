...
const featuresArr = await Promise.all([].concat(
	...
	(await fs.readdir('.')).reduce((cityArr, city) => { // The current directory was cloned from https://github.com/echarts-maps/echarts-china-cityArr-js/tree/master/geojson
		const provinceIndex = ['guang3_dong1', 'guang3_xi1', 'hu2_nan2', 'jiang1_xi1', 'fu2_jian4', 'hai3_nan2', 'gui4_zhou1', 'yun2_nan2', 'chongqing', 'si4_chuan1', 'hu2_bei3', 'an1_hui1', 'zhe4_jiang1', 'shanghai', 'jiang1_su1'].findIndex(province => city.startsWith(province));
